                ...
                try {
                    ...
                    for(int i = 0; i < students.size(); i++){
                        if(i % 2 != 0){
                            ...
                            <div class="row">
                                <div class="child">
                                   <form method="post" action="actionProcess.jsp">
                                       <p>Id: <%=students.get(i - 1).getId() %></p>
                                       <p><label>Name: </label>
                                           <input type="text" name="name" value="<%=students.get(i - 1).getName() %>" class="text" />
                                       </p>
                                       <p><label>Age: </label>
                                           <input type="number" name="age" value="<%=students.get(i - 1).getAge() %>" />
                                       </p>
                                       <p><label>Department: </label>
                                           <input type="text" name="name" value="<%=students.get(i - 1).getDept() %>" class="text"/>
                                       </p>
                                       <input type="submit" class="secondary" name="update" />
                                       <input type="submit" class="danger" name="delete" />
                                   </form>
                                </div>
                                <div class="child">
